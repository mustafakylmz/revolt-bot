    ...
    try {
        ...
        // Mesaj Bileşenlerini (Butonlar, Seçim Menüleri) İşle
            ...
            if (custom_id !== 'faceit_role_request_button') {
                console.log(`DEFERRED_UPDATE_MESSAGE gönderiliyor for custom_id: ${custom_id}`); // DEBUG LOG
                await res.send({
            ...
            switch (custom_id) {
                case 'select_roles_button': // "Rolleri Seç" butonuna basıldığında tetiklenir
                    console.log("select_roles_button tıklandı."); // DEBUG LOG
                    ...
                    console.log("Rol seçim menüsü gönderildi."); // DEBUG LOG
                    break;
                ...
                case 'multi_role_select': // Rol seçim menüsünden seçim yapıldığında tetiklenir
                    console.log("multi_role_select menüsünden seçim yapıldı."); // DEBUG LOG
                    ...
                    for (const roleId of selectedRoleIds) {
                        try {
                            console.log(`Kullanıcıya rol atanıyor: ${roleId}`); // DEBUG LOG
                    ...
                    console.log("Rol seçim yanıtı gönderildi."); // DEBUG LOG
                    break;
        ...
        // Modal Gönderimlerini İşle
            ...
            console.log(`Modal gönderimi alındı. custom_id: ${custom_id}. Defer yanıtı gönderiliyor...`); // DEBUG LOG
            await res.send({
                ...
                try {
                    ...
                    if (!apiResponse.ok) {
                        ...
                        if (playerData && playerData.games && playerData.games.csgo && playerData.games.csgo.skill_level) {
                            ...
                            console.log(`Faceit seviyesi algılandı: ${faceitLevel}`); // DEBUG LOG
                        } else {
