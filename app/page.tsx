    ...
    <div className="min-h-screen bg-revolt-dark">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-revolt-darker/80 backdrop-blur-xl border-b border-revolt-border">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 bg-revolt-accent rounded-xl flex items-center justify-center">
          ...
          <div className="flex items-center gap-4">
            ...
            {session ? (
              <Link
                href="/dashboard"
                className="bg-revolt-accent hover:bg-revolt-accent-hover text-white px-5 py-2.5 rounded-lg font-semibold transition-all hover:scale-105"
              >
                Dashboard
              </Link>
            ) : (
              <button
                ...
                className="bg-revolt-accent hover:bg-revolt-accent-hover text-white px-5 py-2.5 rounded-lg font-semibold transition-all hover:scale-105 flex items-center gap-2"
              >
      ...
      <section className="pt-32 pb-20 px-6">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <h1 className="text-5xl md:text-7xl font-extrabold text-white mb-6 leading-tight">
            ...
            <span className="block text-revolt-accent">Akıllı Rol Yönetimi</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            {session ? (
              <Link
                href="/dashboard"
                className="bg-revolt-accent hover:bg-revolt-accent-hover text-white px-8 py-4 rounded-xl font-bold text-lg transition-all hover:scale-105 w-full sm:w-auto"
              >
                Dashboard&apos;a Git
              </Link>
            ) : (
              <button
                onClick={() => signIn('discord', { callbackUrl: '/dashboard' })}
                className="bg-revolt-accent hover:bg-revolt-accent-hover text-white px-8 py-4 rounded-xl font-bold text-lg transition-all hover:scale-105 w-full sm:w-auto flex items-center justify-center gap-3"
              >
      ...
      <section id="features" className="py-20 px-6 bg-revolt-darker">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {/* Feature 1 */}
            <div className="bg-revolt-card border border-revolt-border rounded-2xl p-8 hover:border-revolt-accent/50 transition-all group">
              <div className="w-14 h-14 bg-revolt-accent/10 border border-revolt-accent/20 rounded-xl flex items-center justify-center mb-6 group-hover:bg-revolt-accent/20 transition-colors">
                <svg className="w-7 h-7 text-revolt-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            {/* Feature 3 */}
            <div className="bg-revolt-card border border-revolt-border rounded-2xl p-8 hover:border-revolt-accent/50 transition-all group">
              <div className="w-14 h-14 bg-revolt-yellow/10 border border-revolt-yellow/20 rounded-xl flex items-center justify-center mb-6 group-hover:bg-revolt-yellow/20 transition-colors">
                <svg className="w-7 h-7 text-revolt-yellow" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
                </svg>
              </div>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="bg-revolt-card border border-revolt-border rounded-2xl p-8 md:p-12">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
              <div>
                <div className="text-3xl md:text-4xl font-extrabold text-revolt-accent mb-2">7/24</div>
      ...
      <section className="py-20 px-6">
        <div className="max-w-3xl mx-auto text-center">
          ...
          {session ? (
            <Link
              href="/dashboard"
              className="inline-block bg-revolt-accent hover:bg-revolt-accent-hover text-white px-10 py-4 rounded-xl font-bold text-lg transition-all hover:scale-105"
            >
              Dashboard&apos;a Git
            </Link>
          ) : (
      ...
      <footer className="py-8 px-6 border-t border-revolt-border">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 bg-revolt-accent rounded-lg flex items-center justify-center">
